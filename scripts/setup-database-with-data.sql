...
-- Insert sample data for all users
-- Diese Daten werden für jeden User erstellt, der sich anmeldet
...
BEGIN
  ...
  FROM bots WHERE user_id = user_id;
END;
$$ LANGUAGE plpgsql;
